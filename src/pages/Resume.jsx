      ...
      >
        ...
        >
          <div>
            ...
            <p style={{ margintop: 10, fontSize: 15, color: "#ccc" }}>
              3rd Year B.Tech — Information Technology | Bhagwan Parshuram Institue Of Technology,GGSIPU
            </p>
            
            <p style={{ margin: "4px 0", fontSize: 14, color: "#aaa" }}>
              ✉️ mehaksuri15@gmail.com | 📞 +91 9716268268
            </p>
          </div>
        ...
        >
          ...
          <ul style={{ listStyle: "none", padding: 0, margin: 0, lineHeight: 1.8 }}>
            <li>
              <strong>B.Tech in Information Technology</strong> — BPIT
              (GGSIPU), 2023–2027 <br />
              <span style={{ color: "#aaa" }}>GPA: 9.0</span>
            </li>
            <li style={{ marginTop: 8 }}>
              <strong>12th Board — New Era Public School</strong> (CBSE, 2023) <br />
              <span style={{ color: "#aaa" }}>Percentage: 90.8%</span>
            </li>
            <li style={{ marginTop: 8 }}>
              <strong>10th Board — New Era Public School</strong> (CBSE, 2021)
              <br />
              <span style={{ color: "#aaa" }}>Percentage: 91.8%</span>
            </li>
          </ul>
        </motion.div>
        ...
        >
          {[
            { name: "🏆 LeetCode", link: "https://leetcode.com/u/mehak_suri15/" },
            { name: "💻 GitHub", link: "https://github.com/mehaksuri1511" },
            { name: "💼 LinkedIn", link: "https://www.linkedin.com/in/mehak-suri-3178602b4/" },
          ].map((site) => (
            <motion.a
              key={site.name}
              href={site.link}
